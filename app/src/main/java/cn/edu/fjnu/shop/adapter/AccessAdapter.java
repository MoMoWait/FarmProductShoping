...
import cn.edu.fjnu.shop.activity.StartActivity;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		aQuery.id(R.id.text_away_access).clicked(new View.OnClickListener() {
			...
			public void onClick(View v) {
		    	...
		    	accessDialog.getWindow().setLayout((int)(CommonUtils.getScreenPixWidth(activity) * 0.8f), -2);
		    	...
		    	accessDialog.getWindow().findViewById(R.id.btn_exit_commit).setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						if(TextUtils.isEmpty(contentEditText.getText().toString())){
							Toast.makeText(context, "反馈内容为空", Toast.LENGTH_SHORT).show();
							return ;
						}
