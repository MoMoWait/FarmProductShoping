...
public class HomeFragment extends Fragment {
	...
	public void initView() {
		...
		LinearLayout.LayoutParams contentLayoutParams = new LinearLayout.LayoutParams(
				...
				CommonValues.screenPixHeight - SizeUtils.dp2px(120));
	...
	public void initEvent() {
		...
		aQuery.id(R.id.img_shop_search).clicked(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if (OPUtils.isEmpty(homeSearchEditText.getText().toString())) {
	...
	public void hideView(int type, int count) {
		...
		LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
				(int) ((CommonValues.screenPixWidth - SizeUtils.dp2px(20)) / 2.0f),
				(int) ((CommonValues.screenPixWidth - SizeUtils.dp2px(20)) / 2.0f * 0.75f));
		if (type == 1) {
			if (count == 0)
	...
	class GetHoteProductInfoTask extends AsyncTask<String, Integer, Integer>{
		...
		protected void onPostExecute(Integer result) {
			...
			if(!OPUtils.isEmpty(productInfoContent)){
				try {
